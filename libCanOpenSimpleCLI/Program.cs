    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            try
            {
                ...
                CanOpenSimpleMaster canopen = new CanOpenSimpleMaster();
                ...
                while (true)
                {
                    ...
                    switch (k.Key)
                    {
                        case ConsoleKey.Q:
                            ...
                            return;
                        case ConsoleKey.F:
                            canopen.SDOwrite(1, 0x60ff, 0x00, 2000, (sdo) => Console.WriteLine($"Completed fast SDO {sdo}"));
                            break;
                        case ConsoleKey.S:
                            canopen.SDOwrite(1, 0x60ff, 0x00, 300, (sdo) => Console.WriteLine($"Completed slow SDO {sdo}"));
                            break;
                        case ConsoleKey.X:
                            canopen.SDOwrite(1, 0x60ff, 0x00, 0, (sdo) => Console.WriteLine($"Completed stop SDO {sdo}"));
                            break;
                    }
                }
            }
        ...
        private static void WriteControlWord(libCanopenSimple.CanOpenSimpleMaster can, ushort controlWord)
        {
            ...
            SDO sdo = can.SDOwrite(1, 0x6040, 0x00, controlWordBytes, null);
        }
    }
}
